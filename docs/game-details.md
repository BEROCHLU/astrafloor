...
| Siren | 4 | 150 | 12 / 16 DPS | ₡120 | Emaciated scream specialist. Radiates an 8.4m acoustic shockwave dealing armor-piercing damage directly to health. Blocked by solid walls and cover. |
...
- **Scream Mechanics**: When within 8.4m of the player, Siren halts navigation and winds up for 0.8s (unhinging her jaw and exposing a pulsating red throat), then unleashes a 1.5s sustained scream followed by a 3.0s cooldown.
- **Armor Bypass**: Screams inflict 12 DPS (Normal: 18 total) / 16 DPS (Hard: 24 total) in 0.25s ticks directly to player HP, completely ignoring body armor.
