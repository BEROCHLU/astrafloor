...
| Siren | 4 | 150 | 24 / 32 DPS | ₡120 | Emaciated scream specialist. Radiates a 9.2m acoustic shockwave dealing armor-piercing damage directly to health. Blocked by solid walls and cover. |
...
- **Scream Mechanics**: When within 9.2m of the player, Siren halts navigation and winds up for 0.8s (unhinging her jaw and exposing a pulsating red throat), then unleashes a 1.5s sustained scream followed by a 3.0s cooldown.
